...
angular.module('MetronicApp').controller('DoctorEditController', ['$rootScope', '$scope', 'settings', '$state', '$http', '$stateParams', function($rootScope, $scope, settings, $state, $http, $stateParams) {
    $scope.row = [];
...
/*An array containing all the country names in the world:*/
        ...
        $http.get(base_url + 'doctor/getDoctorsByRowId?row_id=' + $stateParams.row_id)
    	.success(function (responseData,status,headers,config) {
	...
	$scope.update_doctor_info = function(){
            ...
            !$scope.zipcodevalidation)
            {
                ...
                $http.post(base_url + 'doctor/updateDoctor', data)
        		.success(function (responseData,status,headers,config) {
