...
angular.module('MetronicApp').controller('HospitalAddPatientController', ['$rootScope', '$scope', 'settings', '$state', '$http', '$stateParams', function($rootScope, $scope, settings, $state, $http, $stateParams) {
    ...
    $scope.patient_save_by_institution = function()
    {
        ...
        !$scope.emailvalidation)
        {
            ...
            $http.post(base_url + 'patient/createPatient', data)
