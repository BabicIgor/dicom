...
angular.module('MetronicApp').controller('HospitalAddFacilityController', ['$rootScope', '$scope', 'settings', '$state', '$http', '$stateParams', function($rootScope, $scope, settings, $state, $http, $stateParams) {
    ...
    $scope.create_facility_save = function(){
        ...
        !$scope.zipcodevalidation)
        {
            ...
            $http.post(base_url + 'hospital/createFacility', data)
    		.success(function (responseData,status,headers,config) {
