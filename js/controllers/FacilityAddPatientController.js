...
angular.module('MetronicApp').controller('FacilityAddPatientController', ['$rootScope', '$scope', 'settings', '$state', '$http', '$stateParams', function($rootScope, $scope, settings, $state, $http, $stateParams) {
...
/*An array containing all the country names in the world:*/
    ...
    $scope.patient_close_by_facility = function(){
    ...
    $scope.patient_save_by_facility = function(){
        var fname = $('#fname').val();
        if(fname == '')
        {
            $scope.fnamevalidation = true;
    ...
    //   	!$scope.mnamevalidation &&
        ...
        !$scope.emailvalidation)
        {
            var data = {
                ...
                mname : mname,
                lname : lname,
                facility_id : $stateParams.row_id,
                dob : dob,
                gender : gender,
                race : race,
                ethnicity : ethnicity,
            ...
            $http.post(base_url + 'patient/createPatientByFacility', data)
    		.success(function (responseData,status,headers,config) {
