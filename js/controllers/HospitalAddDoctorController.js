...
angular.module('MetronicApp').controller('HospitalAddDoctorController', ['$rootScope', '$scope', 'settings', '$state', '$http', '$stateParams', function($rootScope, $scope, settings, $state, $http, $stateParams) {
    $scope.row = [];
    ...
    $scope.close_create_doctor_by_institution = function()
    {
    ...
    $scope.create_doctor_save_by_institution = function()
    {
        var fname = $('#fname').val();
        if(fname == '')
        {
