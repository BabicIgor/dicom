...
angular.module('MetronicApp').controller('FacilityAddRadioController', ['$rootScope', '$scope', 'settings', '$state', '$http', '$stateParams', function($rootScope, $scope, settings, $state, $http, $stateParams) {
...
/*An array containing all the country names in the world:*/
    ...
    // }
    $scope.close_create_radio_by_facility = function(){
    ...
    $scope.create_radio_save_by_facility = function()
    {
        ...
        !$scope.zipcodevalidation)
        {
            ...
            $http.post(base_url + 'doctor/createRadioByFacility', data)
    		.success(function (responseData,status,headers,config) {
