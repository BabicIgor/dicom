...
class Chat_model extends CI_Model{
    ...
    public function getChatHistoryByFrom($fromId, $endId)
    {
        
        $query = $this->db->query('SELECT a.* FROM `online_chat` a WHERE (a.`u_f` = '.$fromId.' AND a.`u_t` = '.$endId.') OR (a.`u_f` = '.$endId.' AND a.`u_t` = '.$fromId.') ORDER BY created_time ASC ');
