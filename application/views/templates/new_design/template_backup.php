        ...
        <div class="content" style="background-color:#222227;opacity:0.92;border-radius:2px !important;">
            ...
            <form class="login-form" action="<?php echo base_url();?>login" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" style="border-radius:4px !important;" type="text" placeholder="Email" name="email" /> </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                    <input class="form-control form-control-solid placeholder-no-fix" style="border-radius:4px !important;" type="password" placeholder="Password" name="password" /> </div>
                <div class="form-actions">
                    ...
                    <div class="pull-right forget-password-block" style="width:32%;">
	                    <button type="submit" style="background:#8dc73f;border-radius:4px !important;border:none;" class="btn red btn-block uppercase">Login</button>
                    </div>
                </div>
            ...
            <form class="register-form" action="<?php echo base_url();?>signup" method="post">
                ...
                <div class="form-group">
                    ...
                    <label class="control-label visible-ie8 visible-ie9">Email</label>
                    <input class="form-control placeholder-no-fix" style="border-radius:4px !important;" type="text" placeholder="Email" name="email" /> </div>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" id="register-submit-btn" class="btn blue uppercase pull-right" style="border-radius:4px !important;">Send Email</button>
                    <button type="submit" id="register-submit-btn" class="btn blue uppercase pull-right" style="border-radius:4px !important;">Sign Up</button>
                </div>
