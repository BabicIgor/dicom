...
<html lang="en" data-ng-app="MetronicApp">
    ...
    <body ng-controller="AppController" class="page-header-fixed page-sidebar-closed-hide-logo page-on-load" ng-class="{'page-content-white': settings.layout.pageContentWhite,'page-container-bg-solid': settings.layout.pageBodySolid, 'page-sidebar-closed': settings.layout.pageSidebarClosed}" style="background:#222c3c;">
        ...
        <!-- END PAGE SPINNER -->
        <!-- BEGIN HEADER -->
        <div data-ng-include="'tpl/header.html'" data-ng-controller="HeaderController" class="page-header navbar navbar-fixed-top" style="background-color: #222c3c;box-shadow: 0 6px 5px 0 rgba(0,0,0,0.16), 0 10px 10px 0 rgba(0,0,0,0.12);"> </div>
        <!-- END HEADER -->
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content" style="background-color:#253042 !important">
